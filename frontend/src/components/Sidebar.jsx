...
const routeIcons = {
  ...
  // Add more mappings as needed based on your DASHBOARD_ROUTES
};
...
const LogoutConfirmModal = ({ onConfirm, onCancel }) => (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-80 flex items-center justify-center z-50 transition-opacity duration-300">
        <div className="bg-white p-8 rounded-xl shadow-2xl w-96 max-w-[90%] transform transition-all duration-300 scale-100">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Confirm Logout</h3>
            <p className="text-sm text-gray-600 mb-6 leading-relaxed">Are you sure you want to log out of your account?</p>
...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white h-screen fixed shadow-xl">
            {/* Sidebar Header/Logo */}
            ...
            <nav className="flex-grow p-4 space-y-2 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
                {filteredRoutes.map((route) => (
                    ...
                    >
                        {/* Dynamically select icon based on route name */}
